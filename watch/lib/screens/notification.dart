...
import 'package:watch/widgets/map_key_table.dart';
...
class _NotifScreenState extends State<NotifScreen> {
  ...
  Future<void> _getNearbyPlaces() async {
    if (currentLocation != null) {
      ...
      await _fetchAndDisplayPlaces(
          hospitalsUrl, BitmapDescriptor.hueCyan, 'hospital');
      await _fetchAndDisplayPlaces(
          policeUrl, BitmapDescriptor.hueBlue, 'police');
      await _fetchAndDisplayPlaces(
          fireStationsUrl, BitmapDescriptor.hueOrange, 'fire_station');
    }
  }

  Future<void> _fetchAndDisplayPlaces(
      String url, double markerColor, String type) async {
